...
const MentorSubmission = () => {
  ...
  const dummySubmissions = {
    1: [
      ...
      { id: 103, studentName: 'Jennifer', topic: 'Topic 1', batch: 'Batch C', status: 'Submitted' },
      { id: 104, studentName: 'Alex', topic: 'Topic 2', batch: 'Batch B', status: 'Not Submitted' },
      { id: 105, studentName: 'Emma', topic: 'Topic 1', batch: 'Batch C', status: 'Submitted' },
    ],
    2: [
      { id: 201, studentName: 'Alice Smith', topic: 'Topic 3', batch: 'Batch A', status: 'Submitted' },
      { id: 202, studentName: 'Bob', topic: 'Topic 3', batch: 'Batch B', status: 'Not Submitted' },
      { id: 203, studentName: 'Charlie', topic: 'Topic 2', batch: 'Batch C', status: 'Submitted' },
      { id: 204, studentName: 'David', topic: 'Topic 1', batch: 'Batch A', status: 'Not Submitted' },
      { id: 205, studentName: 'Eva', topic: 'Topic 3', batch: 'Batch B', status: 'Submitted' },
    ],
    3: [
      { id: 301, studentName: 'Johnson', topic: 'Topic 1', batch: 'Batch A', status: 'Submitted' },
      { id: 302, studentName: 'Johnny', topic: 'Topic 3', batch: 'Batch B', status: 'Not Submitted' },
      { id: 303, studentName: 'Parker', topic: 'Topic 2', batch: 'Batch C', status: 'Submitted' },
      { id: 304, studentName: 'Peter', topic: 'Topic 1', batch: 'Batch C', status: 'Not Submitted' },
      { id: 305, studentName: 'Eve', topic: 'Topic 3', batch: 'Batch B', status: 'Submitted' },
    ],
    4: [
      { id: 401, studentName: 'Jennifer', topic: 'Topic 2', batch: 'Batch A', status: 'Submitted' },
      { id: 402, studentName: 'Aizen', topic: 'Topic 1', batch: 'Batch B', status: 'Not Submitted' },
      { id: 403, studentName: 'Kurosaki', topic: 'Topic 3', batch: 'Batch C', status: 'Submitted' },
      { id: 404, studentName: 'Itadori', topic: 'Topic 1', batch: 'Batch A', status: 'Not Submitted' },
      { id: 405, studentName: 'Fushiguro', topic: 'Topic 2', batch: 'Batch A', status: 'Submitted' },
    ],
    5: [
      ...
      { id: 504, studentName: 'David', topic: 'Topic 2', batch: 'Batch D', status: 'Not Submitted' },
      { id: 505, studentName: 'Eva', topic: 'Topic 2', batch: 'Batch E', status: 'Submitted' },
    ],
  ...
  // Function to filter submissions based on selected filters
  const filteredSubmissions = submissions.filter((submission) => {
    const isTopicMatch = !selectedFilter || submission.topic === selectedFilter;
    const isBatchMatch = !selectedFilter || submission.batch === selectedFilter;

    return isTopicMatch || isBatchMatch;
  });
    ...
    <div className="MentorSubmission">
      ...
      <div className="filters">
        ...
        <select id="combinedFilter" value={selectedFilter} onChange={handleFilterChange}>
          ...
          {/* Add more topics and batches as needed */}
        </select>
      </div>
